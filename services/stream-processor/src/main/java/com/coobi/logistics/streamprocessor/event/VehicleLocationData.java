...
/**
 * Movement payload of a location update, as published by the event generator (MVP-1.2).
 *
 * <p>The consumer keeps its own copy of the version-1 contract instead of depending on
 * the producer artifact: the schema version is the contract between the two services, and
 * the consumer validates every field instead of trusting the producer.
 *

...
/**
 * Immutable, versioned vehicle location telemetry event (schema version 1).
 *
 * <p>Serialized form:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>The canonical constructor rejects {@code null} components and any combination
 * that is not the current schema, so an instance either is a valid version-1 event or
 * does not exist. The range constraints declared with {@code jakarta.validation}
 * describe the same contract for validation at the input boundary.
 *
